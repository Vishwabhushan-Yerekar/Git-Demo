...
/** Conformiq generated test case
	Sku_=__CQ_0003_
*/
public class Sku_=__CQ_0003_ extends PageObjectBase
{

	public Sku_=__CQ_0003_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Sku_=__CQ_0003_", "TC_Sku_=__CQ_0003_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Sku_=__CQ_0003_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Sku_=__CQ_0003_","Step_3");
	...
	login_page_init.click_OK();
	getScreenshot(driver,Configurations.screenshotLocation , "Sku_=__CQ_0003_","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Sku_=__CQ_0003_","Step_5");

	Reporter.log("Step - 6- Fill Item form ESD Main screen");

	testReport.fillTableStep("Step 6", "Fill Item form ESD Main screen");

	esd_main_page_init.set_sku("CQ_0003");
	esd_main_page_init.set_qty("5");
	esd_main_page_init.click_Add_Item();
	getScreenshot(driver,Configurations.screenshotLocation , "Sku_=__CQ_0003_","Step_6");
	...
	esd_main_page_init.click_Add_Item();
	esd_main_page_init.click_Add_Item();
	getScreenshot(driver,Configurations.screenshotLocation , "Sku_=__CQ_0003_","Step_7");
	...
	esd_main_page_init.verify_Checkout_Status("Dont care");
	esd_main_page_init.verify_Checkout("Checkout");
	getScreenshot(driver,Configurations.screenshotLocation , "Sku_=__CQ_0003_","Step_8");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Sku_=__CQ_0003_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
