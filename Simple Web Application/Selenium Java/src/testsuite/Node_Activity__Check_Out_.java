...
*/
public class Node_Activity__Check_Out_ extends PageObjectBase
{

	public Node_Activity__Check_Out_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__Check_Out_", "TC_Node_Activity__Check_Out_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Check_Out_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Check_Out_","Step_3");
	...
	login_page_init.click_OK();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Check_Out_","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Check_Out_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Check_Out_","Step_6");
	...
	esd_main_page_init.click_Add_Item();
	esd_main_page_init.click_Add_Item();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Check_Out_","Step_7");
	...
	esd_main_page_init.verify_Checkout_Status("Dont care");
	esd_main_page_init.verify_Checkout("Checkout");
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Check_Out_","Step_8");

	Reporter.log("Step - 9- click Checkout button ESD Main screen");

	testReport.fillTableStep("Step 9", "click Checkout button ESD Main screen");

	esd_main_page_init.click_Checkout();
	esd_main_page_init.click_Checkout();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Check_Out_","Step_9");

	Reporter.log("Step - 10- verify ESD Checkout screen");

	testReport.fillTableStep("Step 10", "verify ESD Checkout screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Check_Out_","Step_10");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__Check_Out_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
