...
/** Conformiq generated test case
	Node_Activity__Invalid_Entry_
*/
public class Node_Activity__Invalid_Entry_ extends PageObjectBase
{

	public Node_Activity__Invalid_Entry_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__Invalid_Entry_", "TC_Node_Activity__Invalid_Entry_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Invalid_Entry_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Invalid_Entry_","Step_3");
	...
	login_page_init.click_OK();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Invalid_Entry_","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Invalid_Entry_","Step_5");

	Reporter.log("Step - 6- Fill Item form ESD Main screen");

	testReport.fillTableStep("Step 6", "Fill Item form ESD Main screen");

	esd_main_page_init.set_sku("12&%");
	esd_main_page_init.set_qty("20");
	esd_main_page_init.click_Add_Item();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Invalid_Entry_","Step_6");
	...
	esd_main_page_init.click_Add_Item();
	esd_main_page_init.click_Add_Item();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Invalid_Entry_","Step_7");

	Reporter.log("Step - 8- verify Error popup");

	testReport.fillTableStep("Step 8", "verify Error popup");

	error_page_init.verify_Text("Invalid sku");
	error_page_init.verify_OK_Status("ENABLED");
	error_page_init.verify_OK("OK");
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Invalid_Entry_","Step_8");

	Reporter.log("Step - 9- verify Error popup");

	testReport.fillTableStep("Step 9", "verify Error popup");

	error_page_init.verify_Text("Invalid qty");
	error_page_init.verify_OK_Status("ENABLED");
	error_page_init.verify_OK("OK");
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Invalid_Entry_","Step_9");
	...
	esd_main_page_init.verify_Checkout_Status("Dont care");
	esd_main_page_init.verify_Checkout("Checkout");
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Invalid_Entry_","Step_10");
	}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__Invalid_Entry_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
